...
SaikuOlapQueryHelper.prototype.editCalculatedMeasure=function(a,b){b&&(this.removeCalculatedMeasure(a),this.removeCalculatedMember(a),this.model().queryModel.calculatedMeasures.push(b))};SaikuOlapQueryHelper.prototype.removeCalculatedMeasure=function(a){var b=this.model().queryModel.calculatedMeasures;(a=_.findWhere(b,{name:a}))&&-1<_.indexOf(b,a)&&(b=_.without(b,a),this.model().queryModel.calculatedMeasures=b)};
SaikuOlapQueryHelper.prototype.getCalculatedMeasures=function(){var a=this.model().queryModel.calculatedMeasures;return a?a:null};SaikuOlapQueryHelper.prototype.addCalculatedMember=function(a){a&&(this.removeCalculatedMember(a.name),this.model().queryModel.calculatedMembers.push(a))};SaikuOlapQueryHelper.prototype.editCalculatedMember=function(a,b){b&&(this.removeCalculatedMeasure(a),this.removeCalculatedMember(a),this.model().queryModel.calculatedMembers.push(b))};
SaikuOlapQueryHelper.prototype.removeCalculatedMember=function(a){var b=this.model().queryModel.calculatedMembers;(a=_.findWhere(b,{name:a}))&&-1<_.indexOf(b,a)&&(b=_.without(b,a),this.model().queryModel.calculatedMembers=b)};SaikuOlapQueryHelper.prototype.getCalculatedMembers=function(){var a=this.model().queryModel.calculatedMembers;return a?a:null};
SaikuOlapQueryHelper.prototype.swapAxes=function(){var a=this.model().queryModel.axes,b=a.ROWS;b.location="COLUMNS";a.ROWS=a.COLUMNS;a.ROWS.location="ROWS";a.COLUMNS=b};SaikuOlapQueryHelper.prototype.nonEmpty=function(a){a?(this.model().queryModel.axes.ROWS.nonEmpty=!0,this.model().queryModel.axes.COLUMNS.nonEmpty=!0):(this.model().queryModel.axes.ROWS.nonEmpty=!1,this.model().queryModel.axes.COLUMNS.nonEmpty=!1)};
var DateFilterModel=Backbone.Model.extend({}),DateFilterCollection=Backbone.Collection.extend({model:DateFilterModel}),SaikuRendererOptions={mode:null,dataMode:null,htmlObject:null,width:null,height:null},SaikuRenderer=function(a,b){this._options=_.extend(SaikuRendererOptions,b);this._hasProcessed=!1;"undefined"!==typeof Backbone&&_.extend(this,Backbone.Events);this.render=function(a,b){var e=null;"undefined"!==typeof Backbone&&this.trigger("render:start",this);this.hasProcessedData()||this.processData(a,
b);e=this._render(a,b);"undefined"!==typeof Backbone&&this.trigger("render:end",this);return e};this.processData=function(a,b){"undefined"!==typeof Backbone&&this.trigger("processData:start",this);this._processData(a,b);"undefined"!==typeof Backbone&&this.trigger("processData:end",this)};this.hasProcessedData=function(){return this._hasProcessed};this._render=function(a,b){};this._processData=function(a,b){};a&&(this._data=a,this.processData(a,b),this._hasProcessed=!0)};
...
function genTotalHeaderRowCells(a,b,c,d,e){for(var f=d[COLUMNS],g=b[COLUMNS],h=c[COLUMNS],k=f.length-2,l="",m=k;0<=m;m--)if(a==g[m]){for(var n=0;n<f[m][h[m]].cells.length;n++){l+="\x3ctr\x3e";for(b=0;b<=k;b++){var s="\x26nbsp;";c=0==m&&0==b?"row":m==b+1?"row_total_corner":m==b&&f[m][h[m]].captions?"row_total_first":m<b+1?"row_total":"row_null";b==k&&(f[m][h[m]].captions&&(s=f[m][h[m]].captions[n]),0==m&&0==h[m]&&(s=f[m][h[m]].captions?s+"\x26nbsp;":"",s+=e?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":
"Grand Total"));l+='\x3cth class\x3d"'+c+'"\x3e'+(e?"\x3cdiv\x3e"+s+"\x3c/div\x3e":s)+"\x3c/th\x3e"}c={};b={};for(s=0;s<d[ROWS].length;s++)c[s]=0,b[s]=d[ROWS][s][c[s]].width;for(s=0;s<f[m][h[m]].cells[n].length;s++)l+='\x3ctd class\x3d"data total"\x3e'+f[m][h[m]].cells[n][s].value+"\x3c/td\x3e",l+=totalIntersectionCells(s+1,d[ROWS].length-1,b,c,d[ROWS]);l+="\x3c/tr\x3e"}h[m]++;h[m]<f[m].length&&(g[m]+=f[m][h[m]].width)}return l}var ROWS="ROWS",COLUMNS="COLUMNS";
...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f=e?e:[],g,h,k,l,m,n=0,s=[],q=null,t=!1,u=!1,z=!1,w=[],B=!0;b&&(q=b.hasOwnProperty("batchSize")?b.batchSize:null,B=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var r={};r[COLUMNS]=a.rowTotalsLists;r[ROWS]=a.colTotalsLists;for(var D={},y={},u=[ROWS,COLUMNS],d=0;d<u.length;d++)D[u[d]]=[],y[u[d]]=[];if(r[COLUMNS])for(d=0;d<r[COLUMNS].length;d++)y[COLUMNS][d]=0,D[COLUMNS][d]=r[COLUMNS][d][y[COLUMNS][d]].width;for(var v=
0,G=f.length;v<G;v++){var H=v-a.topOffset;g=1;var I=u=l=h=!1;if(r[ROWS])for(d=0;d<r[ROWS].length;d++)y[ROWS][d]=0,D[ROWS][d]=r[ROWS][d][y[ROWS][d]].width;d="\x3ctr\x3e";0===v&&(d="\x3cthead\x3e"+d);for(var x=0,J=f[v].length;x<J;x++){var F=x-a.leftOffset,p=e[v][x];"COLUMN_HEADER"===p.type&&(u=!0);if("COLUMN_HEADER"===p.type&&"null"===p.value&&(null==k||x<k))d+='\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e';else if("COLUMN_HEADER"===p.type){null==k&&(k=x);f[v].length==x+1?l=!0:m=e[v][x+1];if(l)"null"==
p.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][v+1][y[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+p.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+v+":"+x+'"\x3e'+p.value+"\x3c/div\x3e":p.value)+"\x3c/th\x3e");else{var F=1<x&&1<v&&!h&&x>k?e[v-1][x+1].value!=e[v-1][x].value||e[v-1][x+1].properties.uniquename!=e[v-1][x].properties.uniquename:!1,C=999<g?!0:!1;p.value!=m.value||nextParentsDiffer(e,v,x)||h||F||C?("null"==
p.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][v+1][y[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+p.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+v+":"+x+'"\x3e'+p.value+"\x3c/div\x3e":p.value)+"\x3c/th\x3e"),g=1):g++}r[ROWS]&&(d+=genTotalHeaderCells(x-a.leftOffset+1,v+1,D[ROWS],y[ROWS],r[ROWS],B))}else if("ROW_HEADER"===p.type&&"null"===p.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';
else if("ROW_HEADER"===p.type){n==x?h=!0:m=e[v][x+1];F=e[v-1];C=!I&&!h&&(0==x||!topParentsDiffer(e,v,x))&&p.value===F[x].value;I=!C;F=C?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+v+":"+x+'"\x3e'+p.value+"\x3c/div\x3e";B||(F=C?"\x26nbsp;":p.value);var C=C?"row_null":"row",E=0;if(!h&&("undefined"==typeof m||"null"===m.value)){var E=1,A=p.properties.dimension,p=p.properties.level,p=A in s?s[A].length-s[A].indexOf(p):1,A=x+1;for(;E<p&&A<=n+1&&"null"!==e[v][A];A++)E=A-x;x=x+E-1}d+='\x3cth class\x3d"'+
C+'" '+(0<E?' colspan\x3d"'+E+'"':"")+"\x3e"+F+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===p.type)d+='\x3cth class\x3d"row_header"\x3e'+(B?"\x3cdiv\x3e"+p.value+"\x3c/div\x3e":p.value)+"\x3c/th\x3e",h=!0,n=x,p.properties.hasOwnProperty("dimension")&&(A=p.properties.dimension,A in s||(s[A]=[]),s[A].push(p.properties.level));else if("DATA_CELL"===p.type){t=!0;C="";A=p.value;E="";if(p.properties.hasOwnProperty("image"))var A=p.properties.hasOwnProperty("image_height")?" height\x3d'"+p.properties.image_height+
"'":"",K=p.properties.hasOwnProperty("image_width")?" width\x3d'"+p.properties.image_width+"'":"",A="\x3cimg "+A+" "+K+" style\x3d'padding-left: 5px' src\x3d'"+p.properties.image+"' border\x3d'0'\x3e";p.properties.hasOwnProperty("style")&&(C=" style\x3d'background-color: "+p.properties.style+"' ");p.properties.hasOwnProperty("link")&&(A="\x3ca target\x3d'__blank' href\x3d'"+p.properties.link+"'\x3e"+A+"\x3c/a\x3e");p.properties.hasOwnProperty("arrow")&&(E="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+
p.properties.arrow+".gif' border\x3d'0'\x3e");d+='\x3ctd class\x3d"data" '+C+"\x3e"+(B?'\x3cdiv class\x3d"datadiv" alt\x3d"'+p.properties.raw+'" rel\x3d"'+p.properties.position+'"\x3e':"")+A+E+(B?"\x3c/div\x3e":"")+"\x3c/td\x3e";r[ROWS]&&(d+=genTotalDataCells(F+1,H,D[ROWS],y[ROWS],r,B))}}d+="\x3c/tr\x3e";g="";r[COLUMNS]&&0<=H&&(g+=genTotalHeaderRowCells(H+1,D,y,r,B));t&&q?v<=q?(u||z||(c+="\x3c/thead\x3e\x3ctbody\x3e",z=!0),c+=d,0<g.length&&(c+=g)):(w.push(d),0<g.length&&w.push(g)):(u||z||(c+="\x3c/thead\x3e\x3ctbody\x3e",
z=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=w,b.hasBatchResult=0<w.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
multiChartIndexes:[0]},heatgrid:{type:"HeatGridChart"},stackedBar100:{type:"NormalizedBarChart"},area:{type:"StackedAreaChart"},dot:{type:"DotChart"},waterfall:{type:"WaterfallChart"},treemap:{type:"TreemapChart"},sunburst:{type:"SunburstChart"},multiplesunburst:{type:"SunburstChart",multiChartIndexes:[1],dataMeasuresInColumns:!0,orientation:"vertical",smallTitlePosition:"top",multiChartMax:30,multiChartColumnsMax:Math.floor(this.cccOptions.width/200),smallWidth:200,smallHeight:150,seriesInRows:!1}};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var g=0,h=0,k=!1,l,m,n,s=function(a,b){return a+b};l=0;for(m=f.length;0===h&&l<m;l++)for(var q=0,t=f[l].length;q<t;q++){if(!k)for(;"COLUMN_HEADER"==f[l][q].type&&"null"==f[l][q].value;)l++;
k=!0;if("ROW_HEADER_HEADER"==f[l][q].type){for(;"ROW_HEADER_HEADER"==f[l][q].type;)b&&d.metadata.push({colIndex:q,colType:"String",colName:f[l][q].value}),q++;g=q-1}if("COLUMN_HEADER"==f[l][q].type){h=0;for(n=[];h<=l;)"null"!==f[h][q].value&&n.push(f[h][q].value),h++;b&&d.metadata.push({colIndex:q,colType:"Numeric",colName:n.join(" ~ ")});h=l+1}}k=[];for(n=0;n<=g;n++)k.push(null);l=h;for(m=f.length;l<m;l++)if(""!==f[l][0].value){t=[];n=[];q=h=null;for(n=0;n<=g;n++){if(f[l]&&"null"===f[l][n].value){for(var e=
d,u=0;u<g&&"null"===f[l][u].value;u++)e=e[k[u]];u>n&&(n=u)}if(f[l]&&"null"!==f[l][n].value){if(0===n)for(u=0;u<=g;u++)k[u]=null;"number"==typeof e&&(h[q]={},e=h[q]);q=f[l][n].value;k[n]=q;e.hasOwnProperty(q)||(e[q]={});h=e;e=e[q]}}n=_.clone(k);e=g+1;for(u=f[l].length;e<u;e++){var z=f[l][e],w=z.value||0,B=0!==w,r=z.properties.raw;r&&"null"!==r?w=parseFloat(r):"number"!==typeof z.value&&parseFloat(z.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(w=parseFloat(z.value.replace(/[^a-zA-Z 0-9.]+/g,"")),B=!1);0<
w&&B&&(w=z.value&&0<=z.value.indexOf("%")?100*w:w);t.push(w);n.push({f:z.value,v:w})}b&&d.resultset.push(n);e=_.reduce(t,s,0);q=null===q?"null":q;h[q]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
var Cube=Backbone.Model.extend({initialize:function(a){this.url=Saiku.session.username+"/discover/"+a.key+"/metadata"},parse:function(a){var b=_.template($("#template-dimensions").html(),{dimensions:a.dimensions}),c=_.template($("#template-measures").html(),{measures:a.measures}),d=_.template($("#template-attributes").html(),{cube:a});this.set({template_measures:c,template_dimensions:b,template_attributes:$(d).html(),data:a});"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("cube."+
this.get("key"),JSON.stringify(this));return a}}),DimensionList=Backbone.View.extend({events:{"click span":"select","click a":"select","click .parent_dimension ul li a.level":"select_dimension","click .measure":"select_measure","click .addMeasure":"measure_dialog"},initialize:function(a){_.bindAll(this,"render","load_dimension","select_dimension");this.workspace=a.workspace;this.cube=a.cube},load_dimension:function(){this.template=this.cube.get("template_attributes");this.render_attributes();this.workspace.sync_query()},
render:function(){if(this.cube&&this.cube.has("template_attributes"))this.load_dimension();else if(this.cube){var a=_.template($("#template-attributes").html());$(this.el).html(a);$(this.el).find(".loading").removeClass("hide");this.workspace.bind("cube:loaded",this.load_dimension)}else $(this.el).html("Could not load attributes. Please log out and log in again.");return this},render_attributes:function(){$(this.el).html(this.template);isIE&&8>=isIE?$(this.el).show():$(this.el).fadeTo(500,1);$(this.el).find(".addMeasure, .calculated_measures").show();
$(this.el).find(".measure").parent("li").draggable({cancel:".not-draggable",connectToSortable:$(this.workspace.el).find(".fields_list_body.details ul.connectable"),helper:"clone",placeholder:"placeholder",opacity:.6,tolerance:"touch",containment:$(this.workspace.el),cursorAt:{top:10,left:35}});$(this.el).find(".level").parent("li").draggable({cancel:".not-draggable, .hierarchy",connectToSortable:$(this.workspace.el).find(".fields_list_body.columns \x3e ul.connectable, .fields_list_body.rows \x3e ul.connectable, .fields_list_body.filter \x3e ul.connectable"),
containment:$(this.workspace.el),helper:function(a,b){var c=$(a.target).hasClass("d_level")?$(a.target):$(a.target).parent(),d=c.find("a").attr("hierarchy"),e=c.find("a").attr("level"),c=c.parent().clone().removeClass("d_hierarchy").addClass("hierarchy");c.find('li a[hierarchy\x3d"'+d+'"]').parent().hide();c.find('li a[level\x3d"'+e+'"]').parent().show();d=$('\x3cli class\x3d"selection"\x3e\x3c/li\x3e');d.append(c);return d},placeholder:"placeholder",opacity:.6,tolerance:"touch",cursorAt:{top:10,
left:85}})},select:function(a){a=$(a.target).hasClass("root")?$(a.target):$(a.target).parent().find("span");a.hasClass("root")&&(a.find("a").toggleClass("folder_collapsed").toggleClass("folder_expand"),a.toggleClass("collapsed").toggleClass("expand"),a.parents("li").find("ul").children("li").toggle());return!1},select_dimension:function(a,b){if("QUERYMODEL"==this.workspace.query.model.type)if($(a.target).parent().hasClass("ui-state-disabled"))a.preventDefault(),a.stopPropagation();else{var c=$(a.target).attr("hierarchy");
$(a.target).parent().parent().attr("hierarchycaption");var d=$(a.target).attr("level"),e="ROWS",f=$(a.target).parent().hasClass("dimension-level-calcmember"),e=0<$(this.workspace.el).find(".workspace_fields ul.hierarchy[hierarchy\x3d'"+c+"']").length?$(this.workspace.el).find(".workspace_fields ul[hierarchy\x3d'"+c+"'] a[level\x3d'"+d+"']").parent().show().parents(".fields_list_body").hasClass("rows")?"ROWS":"COLUMNS":(0<$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'ROWS'] ul.hierarchy").length?
$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'COLUMNS'] ul.connectable"):$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'ROWS'] ul.connectable")).parents(".fields_list").attr("title");f?(f=$(a.target).attr("uniquename"),this.workspace.toolbar.$el.find(".group_parents").removeClass("on"),this.workspace.toolbar.group_parents(),this.workspace.query.helper.includeLevelCalculatedMember(e,c,d,f)):this.workspace.query.helper.includeLevel(e,c,d);Saiku.session.trigger("dimensionList:select_dimension",
...
this.render()},render:function(){$(this.el).attr("id","toolbar").html(this.template());Saiku.events.trigger("toolbar:render",{toolbar:this});return this},call:function(a){var b=$(a.target).attr("href").replace("#","");if(this[b])this[b](a);a.preventDefault()},new_query:function(){"undefined"!=typeof ga&&ga("send","event","MainToolbar","New Query");Saiku.tabs.add(new Workspace);return!1},open_query:function(){var a=_.find(Saiku.tabs._tabs,function(a){return a.content instanceof OpenQuery});a?a.select():
Saiku.tabs.add(new OpenQuery);return!1},logout:function(){Saiku.session.logout()},about:function(){(new AboutModal).render().open();return!1},issue_tracker:function(){window.open("http://jira.meteorite.bi/");return!1},help:function(){window.open("http://wiki.meteorite.bi/display/SAIK/Saiku+Documentation");return!1}}),Upgrade=Backbone.View.extend({events:{},initialize:function(a,b){this.workspace=a.workspace;this.workspace.trigger("workspace:toolbar:render",{workspace:this.workspace})},daydiff:function(a,
b){return Math.round((b-a)/864E5)},render:function(){new License;if(Settings.BIPLUGIN5){void 0!=Saiku.session.get("notice")&&null!=Saiku.session.get("notice")&&""!=Saiku.session.get("notice")&&$(this.el).append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eNotice:"+Saiku.session.get("notice")+"\x3c/div\x3e");
...
if(void 0!=Settings.LICENSE&&"trial"===Settings.LICENSE.licenseType) {
	var a=parseFloat(Settings.LICENSE.expiration),a=new Date(a);
...
"change #show_unique":"show_unique_action","change #use_result":"use_result_action","dblclick .selection_options li.option_value label":"click_move_selection","click li.all_options":"click_all_member_selection","change #show_totals":"show_totals_action"},show_unique_option:!1,use_result_option:Settings.MEMBERS_FROM_RESULT,show_totals_option:"",members_limit:Settings.MEMBERS_LIMIT,members_search_limit:Settings.MEMBERS_SEARCH_LIMIT,members_search_server:!1,selection_type:"INCLUSION",initialize:function(a){_.extend(this,
a);this.options.title="\x3cspan class\x3d'i18n'\x3eSelections for\x3c/span\x3e "+this.name;this.message="Fetching members...";this.query=a.workspace.query;this.selected_members=[];this.available_members=[];_.bindAll(this,"fetch_members","populate","finished","get_members","use_result_action","show_totals_action");this.axis="undefined";a.axis?(this.axis=a.axis,"FILTER"==a.axis&&(this.use_result_option=!1)):(a.target.parents(".fields_list_body").hasClass("rows")&&(this.axis="ROWS"),a.target.parents(".fields_list_body").hasClass("columns")&&
(this.axis="COLUMNS"),a.target.parents(".fields_list_body").hasClass("filter")&&(this.axis="FILTER",this.use_result_option=!1));this.bind("open",this.post_render);this.render();$(this.el).parent().find(".ui-dialog-titlebar-close").bind("click",this.finished);this.member=new Member({},{cube:a.workspace.selected_cube,dimension:a.key});$(this.el).find(".dialog_body").html(_.template($("#template-selections").html())(this));var b=this.member.level;a=this.workspace.query.helper.getHierarchy(this.member.hierarchy);
var c=null;a&&a.levels.hasOwnProperty(b)&&(c=a.levels[b]);"DateFilterModal"===this.source&&_.has(c,"selection")&&0===c.selection.members.length||"DateFilterModal"===this.source&&1===_.size(c)&&_.has(c,"name")?this.$el.find(".dialog_footer a:nth-child(2)").show():this.$el.find(".dialog_footer a:nth-child(2)").hide();Settings.ALLOW_PARAMETERS&&(c&&(b=c.selection?c.selection.parameterName:null)&&$(this.el).find("input.parameter").val(b),$(this.el).find(".parameter").removeClass("hide"));b=$(this.el).find("#show_totals");
b.val("");1<_.size(a.levels)&&c&&c.hasOwnProperty("aggregators")&&c.aggregators?(0<c.aggregators.length&&(this.show_totals_option=c.aggregators[0]),b.removeAttr("disabled")):(b.attr("disabled",!0),this.show_totals_option="");b.val(this.show_totals_option);b.removeAttr("disabled");$(this.el).find("#use_result").attr("checked",this.use_result_option);$(this.el).find(".search_limit").text(this.members_search_limit);$(this.el).find(".members_limit").text(this.members_limit);this.get_members()},open_date_filter:function(a){a.preventDefault();
(new DateFilterModal({dimension:this.objDateFilter.dimension,hierarchy:this.objDateFilter.hierarchy,target:this.target,name:this.name,data:this.objDateFilter.data,analyzerDateFormat:this.objDateFilter.analyzerDateFormat,dimHier:this.objDateFilter.dimHier,key:this.key,workspace:this.workspace})).open();this.$el.dialog("destroy").remove()},show_totals_action:function(a){this.show_totals_option=$(a.target).val()},get_members:function(){var a=this,b="/result/metadata/hierarchies/"+encodeURIComponent(this.member.hierarchy)+
"/levels/"+encodeURIComponent(this.member.level);this.search_path=b;a.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3e'+a.message+"\x3c/span\x3e ");this.workspace.query.action.gett(b,{success:this.fetch_members,error:function(){a.workspace.unblock()},data:{result:this.use_result_option,searchlimit:this.members_limit}})},clear_search:function(){$(this.el).find(".filterbox").val("");this.get_members()},search_members:function(){var a=
this,b=$(this.el).find(".filterbox").val();if(!b)return!1;a.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eSearching for members matching:\x3c/span\x3e '+b);a.workspace.query.action.gett(a.search_path,{async:!1,success:function(b,d){d&&0<d.length&&(a.available_members=d);a.populate()},error:function(){a.workspace.unblock()},data:{search:b,searchlimit:a.members_search_limit}})},fetch_members:function(a,b){b&&0<b.length&&(this.available_members=
b);this.populate()},populate:function(a,b){var c=this;c.workspace.unblock();this.members_search_server=this.available_members.length>=this.members_limit||0==this.available_members.length;c.show_unique_option=!1;$(this.el).find(".options #show_unique").attr("checked",!1);$(this.el).find(".items_size").text(this.available_members.length);this.members_search_server?$(this.el).find(".warning").text("More items available than listed. Pre-Filter on server."):$(this.el).find(".warning").text("");var d=c.member.level,
e=c.workspace.query.helper.getHierarchy(c.member.hierarchy);e&&e.levels.hasOwnProperty(d)&&(this.selected_members=e.levels[d].selection?e.levels[d].selection.members:[],this.selection_type=e.levels[d].selection?e.levels[d].selection.type:"INCLUSION");for(var f=[],d=0,e=this.selected_members.length;d<e;d++)f.push(this.selected_members[d].caption);0==$(this.el).find(".used_selections .selection_options li.option_value").length&&(e=$(this.el).find(".used_selections .selection_options"),e.empty(),d=_.template($("#template-selections-options").html())({options:this.selected_members}),
$(e).html(d));this.available_members=_.select(this.available_members,function(a){return-1===f.indexOf(a.caption)});0<this.available_members.length&&(e=$(this.el).find(".available_selections .selection_options"),e.empty(),d=_.template($("#template-selections-options").html())({options:this.available_members}),$(e).html(d));0<$(c.el).find(".selection_options.ui-selectable").length&&$(c.el).find(".selection_options").selectable("destroy");$(c.el).find(".selection_options").selectable({distance:20,filter:"li",
stop:function(a,b){$(c.el).find(".selection_options li.ui-selected input").each(function(a,b){b&&b.hasAttribute("checked")?b.checked=!0:$(b).attr("checked",!0);$(b).parents(".selection_options").find("li.all_options input").prop("checked",!0)});$(c.el).find(".selection_options li.ui-selected").removeClass("ui-selected")}});$(this.el).find(".filterbox").autocomplete({minLength:1,delay:200,appendTo:".autocomplete",source:function(a,b){var d=0==c.show_unique_option?"caption":"name",e=$.map(c.available_members,
function(b){if(-1<b[d].toLowerCase().indexOf(a.term.toLowerCase()))return{label:0==c.show_unique_option?b.caption:b.uniqueName,value:0==c.show_unique_option?b.uniqueName:b.caption}});b(e)},select:function(a,b){encodeURIComponent(b.item.value);var d=b.item.label,e=0==c.show_unique_option?b.item.value:b.item.label,f=0==c.show_unique_option?b.item.label:b.item.value;$(c.el).find('.available_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();$(c.el).find('.used_selections .selection_options input[value\x3d"'+
...
$(this.el).find(".available_selections, .used_selections").removeClass("unique"))},use_result_action:function(){this.use_result_option=!this.use_result_option;this.get_members()},save:function(){var a=$("\x3cdiv\x3eSaving...\x3c/div\x3e");$(this.el).find(".dialog_body").children().hide();$(this.el).find(".dialog_body").prepend(a);var b=decodeURIComponent(this.member.hierarchy),a=decodeURIComponent(this.member.level),b=this.workspace.query.helper.getHierarchy(b),c=[],d=this.show_totals_option;0!==
$(this.el).find(".used_selections input").length&&$(this.el).find(".used_selections .option_value input").each(function(a,b){var d=$(b).val(),e=$(b).attr("label");c.push({uniqueName:decodeURIComponent(d),caption:decodeURIComponent(e)})});var e=$("#parameter").val();b&&b.levels.hasOwnProperty(a)&&(b.levels[a].aggregators=[],d&&b.levels[a].aggregators.push(d),d=$(this.el).find("input.selection_type:checked").val(),b.levels[a].selection={type:d?d:"INCLUSION",members:c},Settings.ALLOW_PARAMETERS&&e&&
(b.levels[a].selection.parameterName=e,this.workspace.query.helper.model()));this.finished()},finished:function(){$("#filter_selections").remove();this.available_members=null;$(this.el).find(".filterbox").autocomplete("destroy").remove();$(this.el).dialog("destroy");$(this.el).remove();this.query.run()}}),DrillthroughModal=Modal.extend({type:"drillthrough",buttons:[{text:"Ok",method:"ok"},{text:"Cancel",method:"close"}],events:{"click .collapsed":"select","click .expand":"select","click .folder_collapsed":"select",
"click .folder_expanded":"select","click .dialog_footer a":"call","click .parent_dimension input":"select_dimension","click .measure_tree input":"select_measure","click input.all_measures":"select_all_measures","click input.all_dimensions":"select_all_dimensions"},allMeasures:!1,templateContent:function(){return $("#template-drillthrough").html()},initialize:function(a){_.extend(this,a);this.options.title=a.title;this.query=a.workspace.query;this.position=a.position;this.action=a.action;Saiku.ui.unblock();
_.bindAll(this,"ok","drilled","template");this.render();$(this.el).find(".dialog_body").html(_.template(this.templateContent())(this));$(this.el).find(".maxrows").val(this.maxrows);this.query.get("schema");a=$("#template-drillthrough-list").html();var b=Saiku.session.sessionworkspace.cube[e],c=null,d=null,e=this.workspace.selected_cube;b&&b.has("data")&&(c=b.get("data").dimensions,d=b.get("data").measures);b&&c&&d||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+
...
initialize:function(){this.options.title="About "+Settings.VERSION},ObjectLength_Modern:function(a){return Object.keys(a).length},ObjectLength_Legacy:function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&++b;return b},render:function(){$(this.el).html(this.template()).addClass("dialog_"+this.type).dialog(this.options);var a=$(".ui-dialog-title");a.html(this.options.title);a.addClass("i18n");Saiku.i18n.translate();license=new License;void 0!=Settings.LICENSE.expiration&&(yourEpoch=parseFloat(Settings.LICENSE.expiration),
a=new Date(yourEpoch),$(this.el).find(".licenseexpr").text(a.toLocaleDateString()));void 0!=Settings.LICENSE.licenseType?($(this.el).find(".licensetype").text(Settings.LICENSE.licenseType),$(this.el).find(".licensename").text(Settings.LICENSE.name),$(this.el).find(".licenseuserlimit").text(Settings.LICENSE.userLimit),$(this.el).find(".licenseemail").text(Settings.LICENSE.email)):$(this.el).find(".licensetype").text("Open Source License");ObjectLength=Object.keys?this.ObjectLength_Modern:this.ObjectLength_Legacy;
if(void 0!=Settings.LICENSEQUOTA&&0<ObjectLength(Settings.LICENSEQUOTA)){var b="",c=!1;$.each(Settings.LICENSEQUOTA,function(){var a="";$.each(this,function(b,c){a+="\x3ctd\x3e"+c+"\x3c/td\x3e"});b+='\x3ctr class\x3d"'+(c?"odd":"even")+'"\x3e'+a+"\x3c/tr\x3e";c=!c});$(this.el).find("#quotareplace").replaceWith(b)}else $(this.el).find("#licensetable").hide();return this},close:function(a){"#close"===a.target.hash&&a.preventDefault();this.$el.dialog("destroy").remove()}}),OverwriteModal=Modal.extend({type:"info",
message:"Are you sure you want to overwrite the existing query?",buttons:[{text:"Yes",method:"save"},{text:"No",method:"close"}],initialize:function(a){_.extend(this,a);this.options.title="Warning";this.queryname=this.name;this.queryfolder=this.foldername;this.parentobj=this.parent},dummy:function(){return!0},save:function(a){a.preventDefault();this.parentobj.save_remote(this.queryname,this.queryfolder,this.parentobj);$(this.el).dialog("destroy").remove()}}),AddFolderModal=Modal.extend({type:"save",
closeText:"Save",events:{"click .form_button":"save","submit form":"save"},buttons:[{text:"OK",method:"save"}],initialize:function(a){this.success=a.success;this.path=a.path;this.message="\x3cform id\x3d'add_folder'\x3e\x3clabel class\x3d'i18n' for\x3d'name'\x3eTo add a new folder, please type a name in the text box below:\x3c/label\x3e\x3cinput type\x3d'text' class\x3d'newfolder' name\x3d'name' /\x3e\x3c/form\x3e";_.extend(this.options,{title:"Add Folder"});if(isIE&&9>isIE)$(this.el).find("form").on("submit",
this.save)},save:function(a){a.preventDefault();a=$(this.el).find('input[name\x3d"name"]').val();(new SavedQuery({file:this.path+a,name:a})).save({},{success:this.success,dataType:"text",error:this.error});this.close();return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")}}),FilterModal=Modal.extend({type:"filter",closeText:"Save",events:{"submit form":"save","click .dialog_footer a":"call"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],message:"",
expression_text:function(){var a="\x3cform id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e";"Order"==this.expressionType&&(a+="\x3ctr\x3e\x3ctd class\x3d'col1'\x3eSort Type: \x3cselect id\x3d'fun'\x3e\x3coption\x3eASC\x3c/option\x3e\x3coption\x3eBASC\x3c/option\x3e\x3coption\x3eDESC\x3c/option\x3e\x3coption\x3eBDESC\x3c/option\x3e \x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e");return a+="\x3ctr\x3e\x3ctd class\x3d'col1'\x3e"+this.expressionType+" MDX Expression:\x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col1'\x3e\x3ctextarea class\x3d'filter_expression'\x3e\x3c/textarea\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/form\x3e"},
expression:" ",expressonType:"",initialize:function(a){var b=this;this.axis=a.axis;this.query=a.query;this.success=a.success;this.expression=a.expression;this.expressionType=a.expressionType;_.bindAll(this,"save","expression_text");_.extend(this.options,{title:"Custom "+this.expressionType+" for "+this.axis});this.message=this.expression_text(this.expressionType);this.bind("open",function(){$(this.el).find("textarea").val("").val(b.expression)});if(isIE&&9>isIE)$(this.el).find("form").on("submit",
this.save)},save:function(a){a.preventDefault();this.expression=$(this.el).find("textarea").val();a="";"undefined"!=typeof this.expression&&this.expression&&""!==this.expression?("Order"==this.expressionType?(a=$("#fun").val(),this.success(a,this.expression)):this.success(this.expression),this.close()):(a+="You have to enter a MDX expression for the "+this.expressionType+" function! ",alert(a));return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")}}),CustomFilterModal=
Modal.extend({type:"filter",closeText:"Save",events:{"submit form":"save","change .function":"switch_function","change .type":"switch_type","click .dialog_footer a":"call"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],message:"\x3cform id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e\x3ctr\x3e\x3ctd class\x3d'col0'\x3eDefine Filter:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3cselect class\x3d'function'\x3e\x3coption\x3eSelect a Function...\x3c/option\x3e\x3coption value\x3d'TopCount'\x3eTopCount\x3c/option\x3e\x3coption value\x3d'TopPercent'\x3eTopPercent\x3c/option\x3e\x3coption value\x3d'TopSum'\x3eTopSum\x3c/option\x3e\x3coption value\x3d'BottomCount'\x3eBottomCount\x3c/option\x3e\x3coption value\x3d'BottomPercent'\x3eBottomPercent\x3c/option\x3e\x3coption value\x3d'BottomSum'\x3eBottomSum\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3e\x3cspan class\x3d'ntype'\x3e\x3c/span\x3e\x3c/td\x3e\x3ctd\x3e\x3cinput class\x3d'n' /\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3eSort by:\x3c/td\x3e\x3ctd\x3e\x3cselect class\x3d'type'\x3e\x3coption value\x3d'measure'\x3eMeasure\x3c/option\x3e\x3coption value\x3d'custom'\x3eMDX Expression\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3e\x26nbsp;\x3c/td\x3e\x3ctd class\x3d'sortingoption'\x3e\x26nbsp;\x3c/td\x3e\x3c/table\x3e\x3c/form\x3e",
...
""!==a?alert(a):(this.success(this.func,this.n,this.sortliteral),this.close());return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")}}),CalculatedMemberModal=Modal.extend({type:"calculated-member",template_modal:_.template('\x3cdiv class\x3d"cms-container-group"\x3e\x3cdiv class\x3d"calculated-measure-group"\x3e\x3ch4\x3eCalculated Measures:\x3c/h4\x3e\x3cdiv class\x3d"cms-box"\x3e\x3ctable class\x3d"cms-list measures-list"\x3e\x3c%\x3d tplCalculatedMeasures %\x3e\x3c/table\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"calculated-member-group"\x3e\x3ch4\x3eCalculated Members:\x3c/h4\x3e\x3cdiv class\x3d"cms-box"\x3e\x3ctable class\x3d"cms-list members-list"\x3e\x3c%\x3d tplCalculatedMembers %\x3e\x3c/table\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"cms-container-form"\x3e\x3cform class\x3d"form-group-inline" data-action\x3d"cad"\x3e\x3clabel for\x3d"cms-name"\x3eName:\x3c/label\x3e\x3cinput type\x3d"text" id\x3d"cms-name" autofocus\x3e\x3clabel for\x3d"cms-measure"\x3eMeasure:\x3c/label\x3e\x3cselect id\x3d"cms-measure"\x3e\x3coption value\x3d"" selected\x3e-- Add a measure in formula --\x3c/option\x3e\x3c% _(measures).each(function(measure) { %\x3e\x3coption value\x3d"\x3c%\x3d measure.uniqueName %\x3e"\x3e\x3c%\x3d measure.name %\x3e\x3c/option\x3e\x3c% }); %\x3e\x3c/select\x3e\x3clabel for\x3d"\x3c%\x3d idEditor %\x3e"\x3eFormula:\x3c/label\x3e\x3cdiv class\x3d"formula-editor" id\x3d"\x3c%\x3d idEditor %\x3e"\x3e\x3c/div\x3e\x3cdiv class\x3d"btn-group-math"\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"+"\x3e\x26nbsp;+\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"-"\x3e\x26nbsp;-\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"*"\x3e\x26nbsp;*\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"/"\x3e\x26nbsp;/\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"("\x3e\x26nbsp;(\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d")"\x3e\x26nbsp;)\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"and"\x3e\x26nbsp;and\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"or"\x3e\x26nbsp;or\x26nbsp;\x3c/a\x3e\x3ca class\x3d"form_button btn-math" href\x3d"#add_math_operator_formula" data-math\x3d"not"\x3e\x26nbsp;not\x26nbsp;\x3c/a\x3e\x3c/div\x3e\x3cdiv class\x3d"cms-function"\x3e\x3clabel for\x3d"cms-function"\x3eFunctions:\x3c/label\x3e \x3cinput type\x3d"button" class\x3d"form_button growthBtn" style\x3d"padding-bottom: 18px;" value\x3d"Growth"           title\x3d"Calculate difference. Good to calculate previous period growth "   id\x3d"growthBtn" \x3e  \x3c/input\x3e  \x3cinput type\x3d"button" class\x3d"form_button formatBtn" style\x3d"padding-bottom: 18px;" value\x3d"Format %" id\x3d"formatBtn"  title\x3d"Post-process step: format this view as percentage of rows, columns or grand total. " /\x3e\x3c/div\x3e\x3clabel for\x3d"cms-dimension"\x3eDimension:\x3c/label\x3e\x3cselect id\x3d"cms-dimension"\x3e\x3coption value\x3d"" selected\x3e-- Select an existing dimension --\x3c/option\x3e\x3c% if (measures.length \x3e 0) { %\x3e\x3coptgroup label\x3d"\x3c%\x3d dataMeasures.name %\x3e"\x3e\x3coption value\x3d"\x3c%\x3d dataMeasures.uniqueName %\x3e" data-type\x3d"calcmeasure"\x3e\x3c%\x3d dataMeasures.name %\x3e\x3c/option\x3e\x3c/optgroup\x3e\x3c% } %\x3e\x3c% _(dimensions).each(function(dimension) { %\x3e\x3coptgroup label\x3d"\x3c%\x3d dimension.name %\x3e"\x3e\x3c% _(dimension.hierarchies).each(function(hierarchy) { %\x3e\x3coption value\x3d"\x3c%\x3d hierarchy.uniqueName %\x3e" data-dimension\x3d"\x3c%\x3d dimension.name %\x3e" data-type\x3d"calcmember"\x3e\x3c%\x3d hierarchy.name %\x3e\x3c/option\x3e\x3c% }); %\x3e\x3c/optgroup\x3e\x3c% }); %\x3e\x3c/select\x3e\x3clabel for\x3d"cms-format"\x3eFormat:\x3c/label\x3e\x3cselect id\x3d"cms-format"\x3e\x3coption value\x3d"" selected\x3e-- Select a format --\x3c/option\x3e\x3coption value\x3d"custom"\x3eCustom\x3c/option\x3e\x3coption value\x3d"#,##0.00"\x3e#,##0.00 Decimal\x3c/option\x3e\x3coption value\x3d"#,###"\x3e#,### Integer\x3c/option\x3e\x3coption value\x3d"##.##%"\x3e##.##% Decimal percentage\x3c/option\x3e\x3coption value\x3d"##%"\x3e##% Interger percentage\x3c/option\x3e\x3coption value\x3d"mmmm dd yyyy"\x3emmmm dd yyyy Month Day Year\x3c/option\x3e\x3coption value\x3d"mmmm yyyy"\x3emmmm yyyy Month Year\x3c/option\x3e\x3coption value\x3d"yyyy-mm-dd"\x3eyyyy-mm-dd ISO format date\x3c/option\x3e\x3coption value\x3d"yyyy-mm-dd hh:mi:ss"\x3eyyyy-mm-dd hh:mi:ss Date and time\x3c/option\x3e\x3coption value\x3d"##h ##m"\x3e##h ##m Minutes\x3c/option\x3e\x3c/select\x3e\x3cdiv class\x3d"div-format-custom"\x3e\x3clabel for\x3d"cms-format-custom"\x3eFormat Custom:\x3c/label\x3e\x3cinput type\x3d"text" id\x3d"cms-format-custom" value\x3d"" placeholder\x3d"Add a format custom"\x3e\x3c/div\x3e\x3c/form\x3e\x3c/div\x3e'),
buttons:[{text:"Add",method:"save"},{text:"Edit",method:"save"},{text:"New",method:"new"},{text:"Cancel",method:"close"}],events:{"click  .dialog_footer a":"call","blur   #cms-name":"trigger_input_name","change #cms-measure":"add_measure_formula","click  .btn-math":"add_math_operator_formula","change #cms-format":"type_format","click  .btn-action-edit":"edit_cms","click  .btn-action-del":"show_del_cms","click .form_button.growthBtn":"openGrowthModal","click .form_button.formatBtn":"openFormatModal"},
initialize:function(a){_.extend(this,a);this.workspace=a.workspace;this.options.title="Calculated Member";this.id=_.uniqueId("cms-formula-");var b=this,c=this.workspace.selected_cube;a=Saiku.session.sessionworkspace.cube[c].get("data").measures;var c=Saiku.session.sessionworkspace.cube[c].get("data").dimensions,d=this.workspace.query.helper.getCalculatedMeasures(),e=this.workspace.query.helper.getCalculatedMembers(),d=this.template_cms(d,"calcmeasure"),e=this.template_cms(e,"calcmember"),f={name:a?
a[0].dimensionUniqueName.replace(/[\[\]]/gi,""):null,uniqueName:a?a[0].hierarchyUniqueName:null};Saiku.ui.block("Loading...");this.message=this.template_modal({tplCalculatedMeasures:d,tplCalculatedMembers:e,idEditor:this.id,measures:a,dataMeasures:f,dimensions:c});this.bind("open",function(){var a=this.$el.find(".cms-container-form").height();this.post_render();this.$el.find(".dialog_footer a:nth-child(2)").hide();this.$el.find(".dialog_footer a:nth-child(3)").hide();this.$el.find(".cms-container-group").height(a);
this.$el.find(".calculated-measure-group").height(a/2);this.$el.find(".calculated-member-group").height(a/2);_.defer(function(){b.start_editor()})})},post_render:function(){var a=($("body").height()-500)/2*100/$("body").height(),b=($("body").width()-800)/2*100/$("body").width();this.$el.dialog("option","position","center");this.$el.parents(".ui-dialog").css({width:"800px",top:a+"%",left:b+"%"})},start_editor:function(){this.formulaEditor=ace.edit(this.id);this.formulaEditor.getSession().setMode("ace/mode/text");
...
a.name+'" data-type\x3d"calcmeasure"\x3e\x3c/a\x3e\x3c/td\x3e\x3c/tr\x3e'}):_.each(a,function(a){d+='\x3ctr class\x3d"row-cms-'+c.replace_cms(a.name)+'"\x3e\x3ctd class\x3d"cms-name"\x3e'+a.name+'\x3c/td\x3e\x3ctd class\x3d"cms-actions"\x3e\x3ca class\x3d"edit button sprite btn-action-edit" href\x3d"#edit_cms" data-name\x3d"'+a.name+'" data-type\x3d"calcmember"\x3e\x3c/a\x3e\x3ca class\x3d"delete button sprite btn-action-del" href\x3d"#show_del_cms" data-name\x3d"'+a.name+'" data-type\x3d"calcmember"\x3e\x3c/a\x3e\x3c/td\x3e\x3c/tr\x3e'}):
d="calcmeasure"===b?'\x3cp class\x3d"msg-no-cms"\x3eNo calculated measures created\x3c/p\x3e':'\x3cp class\x3d"msg-no-cms"\x3eNo calculated members created\x3c/p\x3e';return d},replace_cms:function(a){return a=a.replace(/\s/g,"-")},edit_cms:function(a){a.preventDefault();var b=this,c=$(a.currentTarget);a="calcmeasure"===c.data("type")?this.workspace.query.helper.getCalculatedMeasures():this.workspace.query.helper.getCalculatedMembers();this.$el.find(".cms-actions a").removeClass("on");_.each(a,function(a){a.name===
...
"DETAILS"==a?this.workspace.query.helper.clearMeasures():this.workspace.query.helper.clearAxis(a);Saiku.session.trigger("workspaceDropZone:clear_axis",{workspace:this.workspace,axis:a});this.workspace.sync_query();this.workspace.query.run();return!1},select_dimension:function(a,b){Saiku.session.trigger("workspaceDropZone:select_dimension",{workspace:this.workspace});if($(b.item).is(":visible")){$(this.el).find(".axis_fields ul.hierarchy").each(function(a,b){$(b).find("li.temphide").show().removeClass("temphide")});
var c=b.item.find(".level").attr("hierarchy"),d=-1;b.item.parents("ul.connectable").find("li.selection").each(function(a,b){$(b).find("ul.hierarchy").attr("hierarchy")==c&&(d=a)});var e=b.item.parents(".axis_fields").parent().attr("title"),f=$(a.target).parents(".axis_fields").parent().attr("title"),g=b.item.hasClass("d_level");if(b.item.hasClass("dimension-level-calcmember"))f=b.item.find("a.level").attr("uniquename"),this.workspace.toolbar.$el.find(".group_parents").removeClass("on"),this.workspace.toolbar.group_parents(),
this.workspace.query.helper.includeLevelCalculatedMember(e,c,h,f,d);else if(g){var h=b.item.find("a.level").attr("level");this.workspace.query.helper.includeLevel(e,c,h,d)}else this.workspace.query.helper.moveHierarchy(f,e,c,d);$(b.item).detach();this.workspace.sync_query();this.workspace.query.run()}},find_type_time:function(a,b,c){void 0===this.workspace.metadata&&(this.workspace.metadata=Saiku.session.sessionworkspace.cube[this.workspace.selected_cube]);var d={};d.dimensions=_.findWhere(this.workspace.metadata.attributes.data.dimensions,
{name:a});void 0===b&&(b=a);d.hierarchies=_.findWhere(d.dimensions.hierarchies,{name:b});if(void 0===d.hierarchies||null===d.hierarchies)d.hierarchies=_.findWhere(d.dimensions.hierarchies,{name:a+"."+b});d.level=_.findWhere(d.hierarchies.levels,{name:c});if(null===d.level||void 0===d.level)d.level=_.findWhere(d.hierarchies.levels,{caption:c});return d},selections:function(a,b){a&&a.preventDefault();var c=$(a.target).hasClass("d_level")?$(a.target).find(".level"):$(a.target),d=c.attr("hierarchy").replace(/[\[\]]/gi,
"").split(".")[0],e=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]?c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]:c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],f=c.attr("level"),g=this.find_type_time(d,e,f),h=c.attr("hierarchy"),k=c.attr("href").replace("#","");this.member=new Member({},{cube:this.workspace.selected_cube,dimension:k});var l=decodeURIComponent(this.member.hierarchy),l=this.workspace.query.helper.getHierarchy(l),m;l&&l.levels.hasOwnProperty(f)&&(m=l.levels[f]);
g.level&&void 0!==g.level.annotations&&null!==g.level.annotations&&(void 0!==g.level.annotations.AnalyzerDateFormat||void 0!==g.level.annotations.SaikuDayFormatString)&&(_.has(m,"selection")&&0===m.selection.members.length||1===_.size(m)&&_.has(m,"name")||_.has(m,"mdx")&&m.mdx||2===_.size(m)&&_.has(m,"name")&&_.has(m,"mdx"))?(new DateFilterModal({dimension:d,hierarchy:e,target:c,name:c.attr("level"),data:g,analyzerDateFormat:g.level.annotations.AnalyzerDateFormat,dimHier:h,key:k,workspace:this.workspace})).open():
(new SelectionsModal({target:c,name:c.text(),key:k,workspace:this.workspace})).open();return!1},measure_action:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();var c={HEADER:{name:"Position",disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",
i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(c,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,build:function(a,e){var f=b.workspace.query;return{callback:function(a,b){var c=f.helper.model().queryModel.details;if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,
c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;else{var d=a.split("_")[0],e=a.split("_")[1];c.location=d;c.axis=e}f.run()}},items:c}}});a.contextMenu()},limit_axis:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,
selector:".limit",ignoreRightClick:!0,build:function(a,f){var g={},h=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,k=b.workspace.query.helper.getAxis(d),l,m,n,s,q,t,u,z,w,B=!1,r=!1,D=!1;k&&k.filters&&_.each(k.filters,function(a){"N"==a.flavour&&(l=k["function"],m=a.expressions[0],n=a.expressions[1],D=!0);"Generic"==a.flavour&&(s=a.expressions[0],B=!0)});k&&k.sortOrder&&(q=k.sortOrder,t=k.sortEvaluationLiteral,r=!0);k&&k.aggregators&&0<k.aggregators.length&&(w=
k.aggregators[0]);null!==l&&null===n?z=l+"###SEPARATOR###"+m:null!==l&&null!==n&&null!==m&&(z="custom");r&&null!==q&&(u="customsort");_.each(h,function(a){g[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});_.each(k.hierarchies,function(a){for(var b in a.levels)console.log(b)});var y=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),c[b+"###SEPARATOR###"+d].fun=b,b==l&&n==d&&a[d].payload.n==m&&(z=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+
"\x3c/b\x3e"),b==q&&t==d&&(u=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},y={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:y(g,"TopCount")},BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:y(g,
"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:y(g,"ASC")},DESCQuick:{name:"Descending",i18n:!0,items:y(g,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:y(g,"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",i18n:!0,items:y(g,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",i18n:!0}}},grand_totals:{name:"Grand totals",
i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",i18n:!0}}},cancel:{name:"Cancel",i18n:!0}};$.each(y,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});var v=y.grand_totals.items;if(w)for(var G in v)G.substring(12)==w&&(v[G].name="\x3cb\x3e"+v[G].name+"\x3c/b");else v.show_totals_not.name="\x3cb\x3e"+v.show_totals_not.name+"\x3c/b";g["10"]={payload:{n:10}};
B&&(w=y.filter,w.name="\x3cb\x3e"+w.name+"\x3c/b\x3e",w.items.customfilter.name="\x3cb\x3e"+w.items.customfilter.name+"\x3c/b\x3e");r&&(r=y.sort.items,y.sort.name="\x3cb\x3e"+y.sort.name+"\x3c/b\x3e",u in r&&(r[u].name="\x3cb\x3e"+r[u].name+"\x3c/b\x3e"));D&&(r=y.limit.items,y.limit.name="\x3cb\x3e"+y.limit.name+"\x3c/b\x3e",z in r&&(r[z].name="\x3cb\x3e"+r[z].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,
"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(k,"Generic");k.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:s,expressionType:"Filter"})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"N"),
b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(k,"N");k.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},(new CustomFilterModal({axis:d,measures:h,success:f,query:b.workspace.query,func:l,n:m,sortliteral:n})).render().open();else if("customsort"==a)f=function(a,c){k.sortOrder=a;k.sortEvaluationLiteral=c;b.synchronize_query();
b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:t,expressionType:"Order"})).render().open();else{if("clearsort"==a)k.sortOrder=null,k.sortEvaluationLiteral=null,b.synchronize_query();else if(0===a.indexOf("show_totals_")){f=a.substring(12);var r=[];r.push(f);k.aggregators=r}else{f=a.split("###SEPARATOR###")[0];var w=a.split("###SEPARATOR###")[1];-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f)?(k.sortOrder=f,k.sortEvaluationLiteral=g[w].payload.sortliteral):
-1<_.indexOf(["Param"],f)?(console.log("here"),k.sortEvaluationLiteral=g[w].payload.sortliteral):(r=[],r.push(g[w].payload.n),(w=g[w].payload.sortliteral)&&r.push(w),b.workspace.query.helper.removeFilter(k,"N"),k.filters.push({flavour:"N",operator:null,"function":f,expressions:r}));b.synchronize_query()}b.workspace.query.run()}},items:y}}});c.contextMenu()}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell"},initialize:function(a){this.workspace=
a.workspace;this.renderer=new SaikuTableRenderer;_.bindAll(this,"render","process_data");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",this.id)},clicked_cell:function(a){var b=this;0<$(this.workspace.el).find(".workspace_results.ui-selectable").length&&$(this.workspace.el).find(".workspace_results").selectable("destroy");a=$(a.target).hasClass("row")||$(a.target).hasClass("col")?$(a.target).find("div"):$(a.target);$(document);$.contextMenu("destroy",
".row, .col");$.contextMenu({appendTo:a,selector:".row, .col",ignoreRightClick:!0,build:function(a,d){var e=$(d.currentTarget).find("div"),f=$(d.currentTarget).hasClass("row")?"ROWS":"COLUMNS",g=e.attr("rel").split(":"),h=parseInt(g[0]),g=parseInt(g[1]),k=b.workspace.query.result.lastresult().cellset[h][g],h=b.workspace.query;h.get("schema");h.get("connection");h.get("catalog");h.get("cube");var l=k.properties.dimension,m=k.properties.hierarchy,n=k.properties.level,s="",q=JSON.stringify({hierarchy:m,
uniquename:n,type:"level",action:"delete"})+","+JSON.stringify({hierarchy:m,uniquename:k.properties.uniquename,type:"member",action:"add"}),h=k.properties.uniquename,t={},g=b.workspace.selected_cube,u;Saiku.session.sessionworkspace.cube[g]&&u&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+g)?Saiku.session.sessionworkspace.cube[g]=new Cube(JSON.parse(localStorage.getItem("cube."+g))):(Saiku.session.sessionworkspace.cube[g]=new Cube({key:g}),Saiku.session.sessionworkspace.cube[g].fetch({async:!1})),
u=Saiku.session.sessionworkspace.cube[g].get("data").dimensions);var z=[],g=b.workspace.query.helper.getHierarchy(m);_.each(g.levels,function(a){z.push(m+".["+a.name+"]")});_.each(u,function(a){a.name==l&&_.each(a.hierarchies,function(a){a.uniqueName==m&&_.each(a.levels,function(a){t[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(z,a.uniqueName)&&(t[a.name].disabled=!0,t["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,
uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==n&&(s=a.caption,l_name=a.name);t["keep-"+a.name]=t[a.name];t["include-"+a.name]=JSON.parse(JSON.stringify(t[a.name]));t["keep-"+a.name].payload=q+","+t[a.name].payload})})});t.keeponly={payload:q};t.getchildren={payload:h};t.hasOwnProperty("remove-"+l_name)&&t.hasOwnProperty("include-"+l_name)&&(t.showall={payload:t["remove-"+l_name].payload+", "+t["include-"+l_name].payload});u=function(a){var b={},c;for(c in t)null!==a&&a.length<
c.length&&c.substr(0,a.length)==a&&(b[c]=t[c]);return b};h={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",i18n:!0,payload:q}};"Measures"!=l&&(h.fold1key={name:"Include Level",i18n:!0,items:u("include-")},h.fold2key={name:"Keep and Include Level",i18n:!0,items:u("keep-")},h.fold3key={name:"Remove Level",i18n:!0,items:u("remove-")},h.filterlevel={name:"Filter Level",i18n:!0});$.each(h,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});
return{callback:function(a,c){var d=[];if("keeponly"===a){var g=b.workspace.query.helper.getHierarchy(m);g&&g.levels.hasOwnProperty(s)&&(d.push({uniqueName:k.properties.uniquename,caption:k.properties.uniquename}),g.levels[s].selection={type:"INCLUSION",members:d},b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))}else if("filterlevel"===a)d=k.properties.level.substring(k.properties.level.lastIndexOf(".")+1),d=d.replace("[","").replace("]",""),(new SelectionsModal({target:e,name:"Filter Level",
key:k.properties.hierarchy+"/"+d,workspace:b.workspace,axis:"ROWS"})).open();else if("remove"===a.substring(0,a.indexOf("-"))){var h=a.substring(a.indexOf("-")+1);b.workspace.query.helper.removeLevel(m,h);b.workspace.drop_zones.synchronize_query();b.workspace.query.run(!0)}else"keep"===a.substring(0,a.indexOf("-"))?(h=a.substring(a.indexOf("-")+1),(g=b.workspace.query.helper.getHierarchy(m))&&g.levels.hasOwnProperty(s)&&(d.push({uniqueName:k.properties.uniquename,caption:k.properties.uniquename}),
g.levels[s].selection={type:"INCLUSION",members:d},b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))):"include"===a.substring(0,a.indexOf("-"))&&(h=a.substring(a.indexOf("-")+1),b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))},items:h}}});a.contextMenu()},render:function(a,b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&
!$(this.el).is(":visible")||null!==a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id);null==a&&(this.workspace.tab.select(),a=document.getElementById(this.id));var b=a.firstChild;b&&a.removeChild(b)},
process_data:function(a){this.workspace.processing.hide();this.workspace.adjust();this.clearOut();$(this.el).html("\x3ctable\x3e\x3c/table\x3e");this.renderer.render(a,{htmlObject:$(this.el).find("table"),batch:Settings.TABLE_LAZY,batchSize:Settings.TABLE_LAZY_SIZE,batchIntervalSize:Settings.TABLE_LAZY_LOAD_ITEMS,batchIntervalTime:Settings.TABLE_LAZY_LOAD_TIME});this.post_process()},post_process:function(){"QM"==this.workspace.query.get("type")&&"view"!=Settings.MODE?$(this.el).addClass("headerhighlight"):
$(this.el).removeClass("headerhighlight");$(this.el).find(".i18n").i18n(Saiku.i18n.po_file);this.workspace.trigger("table:rendered",this)}}),Workspace=Backbone.View.extend({className:"tab_container",events:{"click .sidebar_separator":"toggle_sidebar","change .cubes":"new_query","drop .sidebar":"remove_dimension","drop .workspace_results":"remove_dimension","click .refresh_cubes":"refresh","click .cancel":"cancel","click .admin":"admin"},initialize:function(a){_.bindAll(this,"caption","adjust","toggle_sidebar",
"prepare","new_query","set_class_charteditor","init_query","update_caption","populate_selections","refresh","sync_query","cancel","cancelled","no_results","error","switch_view_state");_.extend(this,Backbone.Events);this.loaded=!1;this.bind("query:result",this.render_result);this.toolbar=new WorkspaceToolbar({workspace:this});this.toolbar.render();this.upgrade=new Upgrade({workspace:this});this.upgrade.render();this.querytoolbar=new QueryToolbar({workspace:this});this.querytoolbar.render();this.drop_zones=
new WorkspaceDropZone({workspace:this});this.drop_zones.render();this.table=new Table({workspace:this});this.chart=new Chart({workspace:this});this.dateFilter=new DateFilterCollection;this.item={};this.viewState=a&&a.viewState?a.viewState:Settings.DEFAULT_VIEW_STATE;this.isReadOnly="view"==Settings.MODE||!1;a&&a.item&&(this.item=a.item)&&this.item.hasOwnProperty("acl")&&0>_.indexOf(this.item.acl,"WRITE")&&(this.isReadOnly=!0,this.viewState="view");a&&(a.query||a.viewState)||(this.viewState="edit");
a&&a.query&&(this.query=a.query,this.query.workspace=this,this.query.save({},{success:this.init_query,error:function(){Saiku.ui.unblock();if(1>$("body").find(".error_loading_query").length){var a=Saiku.i18n&&Saiku.i18n.po_file.error_loading_query?Saiku.i18n.po_file.error_loading_query:null;a||($('\x3cspan class\x3d"i18n error_loading_query"\x3eError Loading Query\x3c/span\x3e').hide().appendTo("body"),Saiku.i18n.translate(),a=$(".error_loading_query").text())}else a=$(".error_loading_query").text();
alert(a)}}));Saiku.session.bind("tab:add",this.prepare);a=Saiku.URLParams.paramsURI();Saiku.URLParams.equals({schema:a.schema,cube:a.cube});this.data_connections(a)},afterRender:function(){console.log("After render")},caption:function(a){if(this.query&&this.query.model){if(this.item&&this.item.name)return this.item.name.split(".")[0];if(this.query.model.mdx)return this.query.model.name}else if(this.query&&this.query.get("name"))return this.query.get("name");a&&Saiku.tabs.queryCount++;return"\x3cspan class\x3d'i18n'\x3eUnsaved query\x3c/span\x3e ("+
Saiku.tabs.queryCount+")"},selected_cube_template:function(a){var b=Saiku.session.sessionworkspace;b.selected=a;return _.template('\x3cselect class\x3d"cubes"\x3e\x3coption value\x3d"" class\x3d"i18n"\x3eSelect a cube\x3c/option\x3e\x3c% _.each(connections, function(connection) { %\x3e\x3c% _.each(connection.catalogs, function(catalog) { %\x3e\x3c% _.each(catalog.schemas, function(schema) { %\x3e\x3c% if (schema.cubes.length \x3e 0) { %\x3e\x3coptgroup label\x3d"\x3c%\x3d (schema.name !\x3d\x3d "" ? schema.name : catalog.name) %\x3e \x3c%\x3d (connection.name) %\x3e"\x3e\x3c% _.each(schema.cubes, function(cube) { %\x3e\x3c% if ((typeof cube["visible"] \x3d\x3d\x3d "undefined" || cube["visible"]) \x26\x26 selected !\x3d\x3d cube.caption) { %\x3e\x3coption value\x3d"\x3c%\x3d connection.name %\x3e/\x3c%\x3d catalog.name %\x3e/\x3c%\x3d ((schema.name \x3d\x3d\x3d "" || schema.name \x3d\x3d\x3d null) ? "null" : schema.name) %\x3e/\x3c%\x3d encodeURIComponent(cube.name) %\x3e"\x3e\x3c%\x3d ((cube.caption \x3d\x3d\x3d "" || cube.caption \x3d\x3d\x3d null) ? cube.name : cube.caption) %\x3e\x3c/option\x3e\x3c% } else if ((typeof cube["visible"] \x3d\x3d\x3d "undefined" || cube["visible"]) \x26\x26 selected \x3d\x3d\x3d cube.caption) { %\x3e\x3coption value\x3d"\x3c%\x3d connection.name %\x3e/\x3c%\x3d catalog.name %\x3e/\x3c%\x3d ((schema.name \x3d\x3d\x3d "" || schema.name \x3d\x3d\x3d null) ? "null" : schema.name) %\x3e/\x3c%\x3d encodeURIComponent(cube.name) %\x3e" selected\x3e\x3c%\x3d ((cube.caption \x3d\x3d\x3d "" || cube.caption \x3d\x3d\x3d null) ? cube.name : cube.caption) %\x3e\x3c/option\x3e\x3c% } %\x3e\x3c% }); %\x3e\x3c/optgroup\x3e\x3c% } %\x3e\x3c% }); %\x3e\x3c% }); %\x3e\x3c% }); %\x3e\x3c/select\x3e')(b)},
...
e,$(this.querytoolbar.el).find("ul.table a."+e).addClass("on")):"map"===d&&(this.querytoolbar.$el.find("ul.chart \x3e li").find("a").removeClass("on"),this.querytoolbar.$el.find('ul.chart [href\x3d"#'+d+'"]').addClass("on"))}catch(f){Saiku.error(this.cid,f)}"table"==Settings.MODE&&this.query?this.query.run(!0):("MDX"==this.query.model.type?(this.query.setProperty("saiku.olap.result.formatter","flat"),$(this.el).find(".sidebar").hasClass("hide")||this.toggle_sidebar(),$(this.el).find(".workspace_fields").addClass("hide"),
...
$(this.querytoolbar.el).find('ul.chart [href\x3d"#charteditor"]').addClass("on")},synchronize_query:function(){this.isReadOnly||Settings.hasOwnProperty("MODE")},sync_query:function(a){if("QUERYMODEL"===this.query.helper.model().type){var b=this;a=a?a:$(b.dimension_list.el);if(!b.isReadOnly&&(!Settings.hasOwnProperty("MODE")||"table"!=Settings.MODE&&"view"!=Settings.MODE)){a.find(".selected").removeClass("selected");var c=b.query.helper.getCalculatedMeasures(),d=b.query.helper.getCalculatedMembers();
c&&0<c.length?(c=_.template($("#template-calculated-measures").html(),{measures:c}),a.find(".calculated_measures").html(c),a.find(".calculated_measures").find(".measure").parent("li").draggable({cancel:".not-draggable",connectToSortable:$(b.el).find(".fields_list_body.details ul.connectable"),helper:"clone",placeholder:"placeholder",opacity:.6,tolerance:"touch",containment:$(b.el),cursorAt:{top:10,left:35}})):a.find(".calculated_measures").empty();if(d&&0<d.length){b=this;a=a.find(".dimension_tree").find(".parent_dimension").find(".d_hierarchy");
var c=d.length,e,f;a.find(".dimension-level-calcmember").remove();for(f=0;f<c;f++)a.each(function(a,c){$(c).attr("hierarchy")===d[f].hierarchyName&&(e=_.template($("#template-calculated-member").html(),{member:d[f]}),e=$(c).closest(".parent_dimension").find("span.root").hasClass("collapsed")?$(e).hide():$(e).show(),$(c).append(e),$(c).find(".level-calcmember").parent("li").draggable({cancel:".not-draggable, .hierarchy",connectToSortable:$(b.el).find(".fields_list_body.columns \x3e ul.connectable, .fields_list_body.rows \x3e ul.connectable, .fields_list_body.filter \x3e ul.connectable"),
containment:$(b.el),helper:function(a,b){var c=$(a.target).hasClass("d_level")?$(a.target):$(a.target).parent(),d=c.find("a").attr("hierarchy"),e=c.find("a").attr("level"),c=c.parent().clone().removeClass("d_hierarchy").addClass("hierarchy");c.find('li a[hierarchy\x3d"'+d+'"]').parent().hide();c.find('li a[level\x3d"'+e+'"]').parent().show();d=$('\x3cli class\x3d"selection selection-calcmember"\x3e\x3c/li\x3e');d.append(c);return d},placeholder:"placeholder",opacity:.6,tolerance:"touch",cursorAt:{top:10,
left:85}}))})}else a.find(".dimension_tree").find(".parent_dimension").find(".d_hierarchy").find(".dimension-level-calcmember").remove();b.drop_zones.synchronize_query()}}Saiku.i18n.translate()},populate_selections:function(a){console.log("populate_selections");a.workspace.sync_query();return!1},update_caption:function(a){a=this.caption(a);this.tab.set_caption(a)},remove_dimension:function(a,b){"QUERYMODEL"==this.query.model.type&&this.drop_zones.remove_dimension(a,b)},update_parameters:function(){var a=
this;$(this.el).find(".parameter_input").html("");if(a.hasOwnProperty("query")&&Settings.ALLOW_PARAMETERS&&"view"!==Settings.MODE&&"view"!==a.viewState){var b="\x3cspan class\x3d'i18n'\x3eParameters\x3c/span\x3e: ",c=this.query.helper.model().parameters,d=!1,e;for(e in c)d="",c[e]&&null!==c[e]&&(d=c[e]),b+="\x3cb\x3e"+e+"\x3c/b\x3e \x3cinput type\x3d'text' placeholder\x3d'"+e+"' value\x3d'"+d+"' /\x3e",d=!0;b+="";d?$(this.el).find(".parameter_input").html(b):$(this.el).find(".parameter_input").html("");
$(this.el).find(".parameter_input input").off("change");$(this.el).find(".parameter_input input").on("change",function(b){var c=$(b.target).attr("placeholder");b=$(b.target).val();a.query.helper.model().parameters[c]=b})}},render_result:function(a){$(this.el).find(".workspace_results_info").empty();if(null!==a.data&&null!==a.data.error)return this.error(a);if(null===a.data||a.data.cellset&&0===a.data.cellset.length)return this.no_results(a);var b=(new Date).getHours();10>b&&(b="0"+b);var c=(new Date).getMinutes();
10>c&&(c="0"+c);b=b+":"+c;c=null!==a.data.runtime?(a.data.runtime/1E3).toFixed(2):"";b='\x3cb\x3e\x3cspan class\x3d"i18n"\x3eInfo:\x3c/span\x3e\x3c/b\x3e \x26nbsp;'+b+"\x26emsp;/ \x26nbsp;"+a.data.width+" x "+a.data.height+"\x26nbsp; / \x26nbsp;"+c+"s";this.update_parameters();$(this.el).find(".workspace_results_info").html(b);a=a.workspace.query.getProperty("saiku.ui.headings");void 0!=a&&(a=JSON.parse(a),b="",null!=a.title&&""!=a.title&&(b='\x3ch3\x3e\x3cspan class\x3d"i18n"\x3eTitle:\x3c/span\x3e\x3c/h3\x3e \x26nbsp;'+
a.title+"\x3cbr/\x3e"),null!=a.variable&&""!=a.variable&&(b+='\x3ch3\x3e\x3cspan class\x3d"i18n"\x3eVariable:\x3c/span\x3e\x3c/h3\x3e \x26nbsp;'+a.variable+"\x3cbr/\x3e"),null!=a.explanation&&""!=a.explanation&&(b+='\x3ch3\x3e\x3cspan class\x3d"i18n"\x3eExplanation:\x3c/span\x3e\x3c/h3\x3e \x26nbsp;'+a.explanation),$(this.el).find(".workspace_results_titles").html(b));this.adjust()},switch_view_state:function(a,b){var c=a||"edit";"edit"==c?(this.toolbar.toggle_fields_action("show",b),this.query&&
"MDX"==this.query.get("type")&&this.toolbar.editor.gotoLine(0),$(this.el).find(".sidebar").hasClass("hide")&&this.toggle_sidebar(),$(this.toolbar.el).find(".auto, .toggle_fields, .toggle_sidebar,.switch_to_mdx, .new").parent().css({display:"block"})):"view"==c&&(this.toolbar.toggle_fields_action("hide",b),$(this.el).find(".sidebar").hasClass("hide")||this.toggle_sidebar(),$(this.toolbar.el).find(".auto, .toggle_fields, .toggle_sidebar,.switch_to_mdx").parent().hide());this.viewState=c;this.update_parameters();
$(window).trigger("resize")},block:function(a){Settings.LOGO_32x32?$(this.el).block({message:'\x3cimg class\x3d"saiku_logo_override" style\x3d"float:left" src\x3d"'+Settings.LOGO_32x32+'"/\x3e '+a}):$(this.el).block({message:'\x3cspan class\x3d"saiku_logo" style\x3d"float:left"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e '+a});Saiku.i18n.translate()},unblock:function(){isIE||$(this.el).unblock();Saiku.ui.unblock()},cancel:function(a){var b=this;a&&a.preventDefault();this.query.action.del("/cancel",{success:function(){b.cancelled()}})},
admin:function(a){Saiku.AdminConsole.show_admin()},cancelled:function(a){this.processing.html('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eCanceling Query...\x3c/span\x3e').show()},no_results:function(a){this.processing.html('\x3cspan class\x3d"i18n"\x3eNo Results\x3c/span\x3e').show()},error:function(a){this.processing.html(safe_tags_replace(a.data.error)).show()}}),DeleteRepositoryObject=Modal.extend({type:"delete",buttons:[{text:"Yes",method:"del"},
{text:"No",method:"close"}],initialize:function(a){this.options.title="Confirm deletion";this.query=a.query;this.success=a.success;this.message='\x3cspan class\x3d"i18n"\x3eAre you sure you want to delete \x3c/span\x3e\x3cspan\x3e'+this.query.get("name")+"?\x3c/span\x3e"},del:function(){this.query.set("id",_.uniqueId("query_"));this.query.id=_.uniqueId("query_");this.query.url=this.query.url()+"?file\x3d"+encodeURIComponent(this.query.get("file"));this.query.destroy({success:this.success,dataType:"text",
error:this.error,wait:!0});this.close()},error:function(){$(this.el).find("dialog_body").html('\x3cspan class\x3d"i18n"\x3eCould not delete repository object\x3c/span\x3e')}}),MoveRepositoryObject=Modal.extend({type:"save",closeText:"Move",events:{click:"select_root_folder","click .dialog_footer a":"call","click .query":"select_name","dblclick .query":"open_query","click li.folder":"toggle_folder","keyup .search_file":"search_file","click .cancel_search":"cancel_search","click .export_btn":"export_zip",
"change .file":"select_file"},buttons:[{id:"test",text:"Move",method:"open_query"},{text:"Cancel",method:"close"}],initialize:function(a){var b=this;this.movefolder=a.query;this.success=a.success;this.message='\x3cbr/\x3e\x3cb\x3e\x3cdiv class\x3d\'query_name\'\x3e\x3cspan class\x3d\'i18n\'\x3ePlease select a folder.....\x3c/span\x3e\x3c/div\x3e\x3c/b\x3e\x3cbr/\x3e\x3cdiv class\x3d\'RepositoryObjects\'\x3eLoading....\x3c/div\x3e\x3cbr\x3e\x3cdiv style\x3d"height:25px; line-height:25px;"\x3e\x3cb\x3e\x3cspan class\x3d"i18n"\x3eSearch:\x3c/span\x3e\x3c/b\x3e \x26nbsp; \x3cspan class\x3d"search"\x3e\x3cinput type\x3d"text" class\x3d"search_file"\x3e\x3c/input\x3e\x3cspan class\x3d"cancel_search"\x3e\x3c/span\x3e\x3c/span\x3e\x3c/div\x3e';
...
{name:this.selected_query.get("name")}),d=null;a&&!a.hasOwnProperty("currentTarget")&&(d=a);"saiku"===b.fileType?Saiku.tabs.add(new Workspace({query:c,item:b,viewState:d})):Saiku.session.trigger("openQuery:open_query",{query:c,item:b,viewState:d});return!1},open_contents:function(a){var b=[],c=this.queries[this.selected_query.get("file")];_.forEach(c.repoObjects,function(a){"FILE"===a.type&&b.push(a)});(new WarningModal({title:"Open Multiple Queries",message:"You are about to open "+b.length+" queries",
okay:this.run_open_contents,okayobj:{files:b,viewstate:a}})).render().open();return!1},run_open_contents:function(a){_.forEach(a.files,function(b){Saiku.ui.block("Opening query...");var c=_.extend({file:b.path,formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS),c=new Query(c,{name:b.name}),d=null;a.viewstate&&!a.viewstate.hasOwnProperty("currentTarget")&&(d=viewstate);Saiku.tabs.add(new Workspace({query:c,item:b,viewState:d}))})},edit_query:function(){this.open_query("edit")},delete_repoObject:function(a){(new DeleteRepositoryObject({query:this.selected_query,
success:this.clear_query})).render().open();return!1},move_repoObject:function(a){(new MoveRepositoryObject({query:this.selected_query,success:this.clear_query})).render().open();return!1},edit_folder:function(a){alert("todo: edit folder properties/permissions");return!1},edit_permissions:function(a){(new PermissionsModal({workspace:this.workspace,title:"\x3cspan class\x3d'i18n'\x3ePermissions\x3c/span\x3e",file:this.selected_query.get("file")})).open()},clear_query:function(){$(this.el).find(".workspace_toolbar").addClass("hide");
$(this.el).find(".workspace_results").html("");this.fetch_queries()},adjust:function(){$separator=$(this.el).find(".sidebar_separator");$separator.height($("body").height()-87);$(this.el).find(".sidebar").css({width:300,height:$("body").height()-87});$(this.el).find(".workspace_inner").css({"margin-left":305});$(this.el).find(".workspace").css({"margin-left":-305});$(this.el).find(".workspace_results").css({width:$(document).width()-$(this.el).find(".sidebar").width()-30,height:$(document).height()-
$("#header").height()-$(this.el).find(".workspace_toolbar").height()-$(this.el).find(".workspace_fields").height()-40})},toggle_sidebar:function(){$(this.el).find(".sidebar").toggleClass("hide");var a=$(this.el).find(".sidebar").hasClass("hide")?5:265;$(this.el).find(".workspace_inner").css({"margin-left":a})},unselect_current_selected:function(){$(this.el).find(".selected").removeClass("selected")}}),SaveQuery=Modal.extend({type:"save",closeText:"Save",events:{click:"select_root_folder","click .dialog_footer a":"call",
"submit form":"save","click .query":"select_name","click li.folder":"toggle_folder","keyup .search_file":"search_file","click .cancel_search":"cancel_search"},buttons:[{text:"Save",method:"save"},{text:"Cancel",method:"close"}],folder_name:null,file_name:null,initialize:function(a){var b=this,c="",d="";if(a.query.name){a.query.name=a.query.name.replace(/:/g,"/");var e=a.query.name.split("/"),d=a.query.name;this.file_name=c=e[e.length-1];1<e.length&&(this.folder_name=e.splice(0,e.length-1).join("/"))}this.query=
a.query;this.message=_.template("\x3cform id\x3d'save_query_form'\x3e\x3cdiv class\x3d\"box-search-file\" style\x3d\"height:25px; line-height:25px;\"\x3e\x3cb\x3e\x3cspan class\x3d\"i18n\"\x3eSearch:\x3c/span\x3e\x3c/b\x3e \x26nbsp; \x3cspan class\x3d\"search\"\x3e\x3cinput type\x3d\"text\" class\x3d\"search_file\"\x3e\x3c/input\x3e\x3cspan class\x3d\"cancel_search\"\x3e\x3c/span\x3e\x3c/span\x3e\x3c/div\x3e\x3cdiv class\x3d'RepositoryObjects'\x3e\x3cspan class\x3d'i18n'\x3eLoading...\x3c/span\x3e\x3c/div\x3e\x3clabel for\x3d'name' class\x3d'i18n'\x3eFile:\x3c/label\x3e\x26nbsp;\x3cinput type\x3d'text' name\x3d'name' value\x3d'\x3c%\x3d name %\x3e' /\x3e\x3cbr /\x3e\x3c/form\x3e")({name:d});
...
initialize:function(a){_.extend(this,a);this.options.title='\x3cspan class\x3d"i18n"\x3eDate Filter\x3c/span\x3e';this.message="Loading...";this.query=a.workspace.query;this.selectedDates=[];this.levelInfo={cube:this.get_cube_name(),dimension:this.dimension,hierarchy:this.hierarchy,name:this.name};_.bindAll(this,"finished");this.bind("open",this.post_render);this.render();this.show_button_clear()?(this.$el.find(".dialog_footer a:nth-child(1)").show(),this.$el.find(".dialog_footer a:nth-child(3)").hide()):
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,g,h,k,l,m=0,n=a.length,s=Math.max,q="";m<n;){c=a.charCodeAt(m++)||0;f=a.charCodeAt(m++)||0;l=a.charCodeAt(m++)||0;if(255<s(c,f,l))throw b;g=c>>2&63;c=(c&3)<<4|f>>4&15;h=(f&15)<<2|l>>6&3;k=l&63;f?l||(k=64):h=k=64;q+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
